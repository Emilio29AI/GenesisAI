...
function GenerateIdeaInteractiveContent() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-900/20 text-white">
      ...
      {/* --- MODAL "RESUMEN BÁSICO" (Como lo tenías) --- */}
      {isModalOpen && selectedIdea && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={closeModal}>
          {/* ... (Contenido del modal como lo tenías, asegurándote de que las funciones y variables sean correctas) ... */}
...
// Asegúrate de que el nombre del componente exportado coincida con el que esperas.
// Si tu componente principal se llama GenerateIdeaInteractiveContent:
